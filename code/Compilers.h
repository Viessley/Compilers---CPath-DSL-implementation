...
/* TO_DO: Adjust your language (language name: "CPath") */
/* Language name */
#define STR_LANGNAME	"CPath"
...
typedef char*			cp_strg;
typedef int				cp_intg;
typedef float			cp_real;
typedef void			cp_void;

typedef unsigned char	cp_boln;
typedef unsigned char	cp_byte;

typedef long			cp_long;
typedef double			cp_doub;
